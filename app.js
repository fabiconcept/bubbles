...
document.onmouseleave = function() {
    dragValue = 0;
    // dragValue.style.marginLeft = 0 + "px";
}
document.onmousemove = function(e){
    var x = e.pageX;
    document.getElementById('rec').innerHTML = (x/3.1452) + "px";
    dragValue.style.marginLeft = (x/3) + "px";
}
...
var div_Ani = document.getElementById('pop-sm');
div_Ani.addEventListener('click', ()=>{
    alert(0);
})
function showPop1() {
    if (onDevice=='mobile') {
